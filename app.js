...
(function () {
  ...
  function isEntryScreenActive() {
    ...
    const editOpen = document.getElementById("editOverlay") &&
                     document.getElementById("editOverlay").classList.contains("open");
    const entryVisible = entryTab && getComputedStyle(entryTab).display !== "none";
